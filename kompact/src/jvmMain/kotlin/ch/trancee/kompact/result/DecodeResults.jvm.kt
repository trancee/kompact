 ...
 *
 * JVM `actual` for the result value classes. Carries `@JvmInline` per
 * Ticket 03's value-class representation rule (the annotation is
 * allowed only on the generated JVM `actual`; common source stays
 * annotation-free per PROMPT.md §1).
 */
